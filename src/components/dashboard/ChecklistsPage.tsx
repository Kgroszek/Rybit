...
export function ChecklistsPage({
  ...
  return (
      ...
      <div className="grid min-w-0 max-w-full gap-6 xl:grid-cols-[320px_minmax(0,1fr)]">
        <aside className="space-y-6">
          <section className="min-w-0 max-w-full rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 md:hidden">
              {checklists.length > 0 ? (
                <select
                  ...
                  className="h-12 w-full max-w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm font-semibold outline-none transition focus:border-blue-500"
                >
...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="min-w-[150px] max-w-full rounded-3xl border border-slate-200 bg-white p-4 shadow-sm md:min-w-0 md:p-5">
