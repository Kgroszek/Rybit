...
export default async function PodkarpackieLakesPage() {
  ...
  const podkarpackieLakes = lakes.filter((lake) => {
    const voivodeship = lake.address.voivodeship.toLowerCase();

    return (
      voivodeship.includes("podkarpackie") ||
      voivodeship.includes("podkarpacie") ||
      voivodeship.includes("podkarpacki") ||
      voivodeship.includes("podkarpacka")
    );
  });
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-4xl">
            <p className="mb-5 inline-flex rounded-full border border-blue-100 bg-white px-4 py-2 text-sm font-bold text-blue-700 shadow-sm">
              Publiczna baza łowisk w województwie podkarpackim
            </p>

            <h1 className="text-4xl font-black tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
              Łowiska podkarpackie – znajdź miejsce na ryby w województwie
              podkarpackim
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
              Szukasz łowiska na Podkarpaciu? Sprawdź publiczną bazę łowisk w
              województwie podkarpackim, porównuj miejsca według gatunków ryb,
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Przeglądaj łowiska podkarpackie
              </a>
            ...
            <div className="mt-10 grid max-w-2xl gap-4 sm:grid-cols-3">
              <HeroStat
                value={String(podkarpackieLakes.length)}
                label="łowisk w bazie"
              />
              <HeroStat value="Podkarpackie" label="województwo" />
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4 leading-8 text-slate-600">
              ...
              <p>
                Na tej stronie znajdziesz łowiska podkarpackie dostępne w bazie
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4 leading-8 text-slate-600">
            <p>
              Wybierając łowisko w województwie podkarpackim, warto sprawdzić
