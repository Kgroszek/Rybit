...
export default async function MalopolskieLakesPage() {
  ...
  const malopolskieLakes = lakes.filter((lake) => {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-4xl">
            <p className="mb-5 inline-flex rounded-full border border-blue-100 bg-white px-4 py-2 text-sm font-bold text-blue-700 shadow-sm">
              Publiczna baza łowisk w województwie małopolskim
            </p>

            <h1 className="text-4xl font-black tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
              Łowiska małopolskie – znajdź miejsce na ryby w województwie
              małopolskim
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
              Szukasz łowiska w Małopolsce? Sprawdź publiczną bazę łowisk w
              województwie małopolskim, porównuj miejsca według gatunków ryb,
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Przeglądaj łowiska małopolskie
              </a>
            ...
            <div className="mt-10 grid max-w-2xl gap-4 sm:grid-cols-3">
              <HeroStat
                value={String(malopolskieLakes.length)}
                label="łowisk w bazie"
              />
              <HeroStat value="Małopolskie" label="województwo" />
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4 leading-8 text-slate-600">
              ...
              <p>
                Na tej stronie znajdziesz łowiska małopolskie dostępne w bazie
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4 leading-8 text-slate-600">
            <p>
              Wybierając łowisko w województwie małopolskim, warto sprawdzić
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-6 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <p>© {new Date().getFullYear()} Rybio. Łowiska małopolskie.</p>
